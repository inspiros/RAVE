...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.freeze_anchors = False
        self.freeze_mlp = False
        self.update_masks_freq = 0
    ...
    def extract(self, args):
        ...
        if group.freeze_anchors and group.freeze_mlp:
            raise ValueError("Freeze everything and what do you train?")
        return group
